...
export type ClientSideToolV2Params =
...
export type ClientSideToolV2ResultValue =
...
export interface ClientSideToolV2Call {
  ...
  readonly params: ClientSideToolV2Params;
}
export interface ClientSideToolV2Result {
  readonly toolCallId: string;
  readonly tool: ClientSideToolV2;
  readonly error?: ToolResultError;
  readonly result: ClientSideToolV2ResultValue;
}
