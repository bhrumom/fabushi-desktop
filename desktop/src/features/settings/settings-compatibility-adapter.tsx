...
import type { DesktopMessengerPreferences, InferenceRouterStatus, SettingsCategory, UsageSummary } from '../../adapters/compatibility/compatibility-model';
import FabAvatar from '../../ui/avatar/fab-avatar';
import { FabSelect } from '../../ui/primitives/fab-primitives';
...
export function SettingsCompatibilityAdapter({ category, preferences, onPreference, actor, actorId, hostSettings, onHostSetting, onConfigureProviderSecret, onRemoveProviderSecret, routerStatus, usageSummary, onInstallUpdate, onLogout }: SettingsWorkspaceProps) {
