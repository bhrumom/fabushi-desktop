...
const DELETE_AGENT_ACTION: AgentRowAction = { id:'delete-agent',label:'Delete' };
const COPY_CONVERSATION_ID_ACTION: AgentRowAction = { id:'copy-conversation-id',label:'Copy conversation ID' };
const DUPLICATE_AGENT_ACTION: AgentRowAction = { id:'duplicate-agent',label:'Duplicate' };
...
export function isHideFromSidebarAction(action:AgentRowAction){return action.id==='hide-from-sidebar'}
export function isTogglePinAction(action:AgentRowAction){return action.id==='pin-agent'||action.id==='unpin-agent'}
export function togglePinValue(action:AgentRowAction){return action.id==='pin-agent'}
export function isDeleteAgentAction(action:AgentRowAction){return action.id==='delete-agent'}
export function isCopyConversationIdAction(action:AgentRowAction){return action.id==='copy-conversation-id'}
export function isDuplicateAgentAction(action:AgentRowAction){return action.id==='duplicate-agent'}
export function isMarkAgentUnreadAction(action:AgentRowAction){return action.id==='mark-read'||action.id==='mark-unread'}
export function markAgentUnreadValue(action:AgentRowAction){return action.id==='mark-unread'}
